  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        ...
        <p><a class="btn btn-lg btn-success" href="servidorcontroller?action=lista" role="button">Ver todos los Servidores</a></p>                
      </div>
      ...
      <div class="row">
        ...
        <c:forEach items="${ultimos}" var="servidor" varStatus="status">
           ...
           <div class="col-lg-4">
            ...
            <p><a class="btn btn-primary" href="servidorcontroller?action=ver&id=${servidor.id}" role="button">Ver Detalles&raquo;</a></p>
          </div> 
