    ...
    <div class="container">
      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
          ...
          <h5><b>Publicado</b>: ${servidor.getFecha()}</h5>                             
          <b>Descripción:</b><br>
          ...
          -->          
          <p><a class="btn btn-default btn-success" title="Reservar" href="servidorcontroller?action=enviar&id=${servidor.id}" role="button">Reservar</a></p>
        </div>
